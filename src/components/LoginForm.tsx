...
const LoginForm = () => {
  ...
  return (
    <div className="w-full max-w-md border border-dental-gold/30 rounded-lg bg-dental-dark overflow-hidden">
      <div className="p-6">
        <h2 className="text-dental-gold text-2xl mb-2">Welcome to Dental Quick</h2>
        ...
        <Tabs defaultValue="login" className="w-full mb-6">
          <TabsList className="grid w-full grid-cols-2 bg-dental-darkGray">
            <TabsTrigger value="login" className="data-[state=active]:bg-dental-dark">Login</TabsTrigger>
            <TabsTrigger value="register" className="data-[state=active]:bg-dental-dark">Register</TabsTrigger>
          </TabsList>
        </Tabs>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <a href="#" className="text-dental-gold text-sm hover:underline">Forgot Password?</a>
            </div>
            <Input
              id="password"
              type="password"
          ...
          <Button 
            type="button"
            variant="outline" 
            className="w-full border-dental-gold/50 text-dental-gold hover:bg-dental-gold/10"
          >
            Try Demo Access
          </Button>
        </form>
